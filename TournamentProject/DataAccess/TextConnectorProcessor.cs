...
namespace TournamentProject.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
        public static string FullFilePath(this string fileName)
        {
            // D:\Projects\C# Aplication\TextFiles\
        ...
        public static List<MatchupEntryModel> ConvertToMatchupEntryModels(this List<string> lines)
        {
            ...
            foreach (string line in lines)
            {
                ...
                int teamCompetingId = 0;
                if (int.TryParse(cols[1], out teamCompetingId))
                {
                    me.TeamCompeting = LookupTeamById(teamCompetingId);
                }
                else
                {
                ...
                double score = 0;
                if (double.TryParse(cols[2], out score))
                {
                    me.Score = score;
                }
                else
